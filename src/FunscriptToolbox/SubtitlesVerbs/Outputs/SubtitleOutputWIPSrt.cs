...
//                    .OrderBy(item => item.TranscribedItem.StartTime)
...
//            public ExtraTranscription(string transcriptionId, TranscribedItem transcribedIrem)
//            {
//                TranscriptionId = transcriptionId;
//                TranscribedItem = transcribedIrem;
//            }
//        }
...
//        {
//            while (extraTranscriptions.Count > 0 && (currentTiming == null || extraTranscriptions.First().TranscribedItem.StartTime <= currentTiming))
//            {
